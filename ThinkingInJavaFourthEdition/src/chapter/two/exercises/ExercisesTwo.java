...
public class ExercisesTwo {
     ...
     *     <body>
     *         <ol>
     *            <li>Exercise 1:   (1) Write a program that uses the short and normal form of print statement.</li>
     *
     *            <li>Exercise 2:  (1) Create a class containing a float and use it to demonstrate aliasing.</li>
     *
     *            <li>Exercise 3:  (1) Create a class containing a float and use it to demonstrate aliasing during
     *                  method calls.</li>
     *
     *            <li>Exercise 4:  (2) Write a program that calculates velocity using a constant distance and a
     *                  constant time.</li>
     *
     *            <li>Exercise 5:  (2) Create a class called Dog containing two Strings: name and says. In main( ),
     *                  create two dog objects with names spot (who says, Ruff!) and scruffy (who says, Wurf!). Then
     *                  display their names and what they say.</li>
     *
     *            <li>Exercise 6:  (3) Following Exercise 5, create a new Dog reference and assign it to spots object.
     *                  Test for comparison\ using == and equals( ) for all references.</li>
     *
     *            <li>Exercise 7:  (3) Write a program that simulates coin-flipping.</li>
     *
     *            <li>Exercise 8:  (2) Show that hex and octal notations work with long values. Use
     *                  Long.toBinaryString( ) to display the results.</li>
     *
     *            <li>Exercise 9:  (1) Display the largest and smallest numbers for both float and double exponential
     *                  notation.</li>
     *
     *            <li>Exercise 10:    (3) Write a program with two constant values, one with alternating binary ones
     *                  and zeroes, with a zero in the least-significant digit, and the second, also alternating, with
     *                  a one in the least-significant digit (hint: Its easiest to use hexadecimal constants for this).
     *                  Take these two values and combine them in all possible ways using the bitwise operators, and
     *                  display the results using Integer.toBinaryString( ).</li>
     *
     *            <li>Exercise 11:    (3) Start with a number that has a binary one in the most significant position
     *                  (hint: Use a hexadecimal constant). Using the signed right-shift operator, right shift it all
     *                  the way through all of its binary positions, each time displaying the result using
     *                  Integer.toBinaryString( ).</li>
     *
     *            <li>Exercise 12:    (3) Start with a number that is all binary ones. Left shift it, then use the
     *                  unsigned right-shift operator to right shift through all of its binary positions, each time
     *                  displaying the result using Integer.toBinaryString( ).</li>
     *
     *            <li>Exercise 13:    (1) Write a method that displays char values in binary form. Demonstrate it using
     *                  several different characters.</li>
     *
     *            <li>Exercise 14:    (3) Write a method that takes two String arguments and uses all the boolean
     *                  comparisons to compare the two Strings and print the results. For the == and !=, also perform
     *                  the equals( ) test. In main( ), call your method with some different String objects.</li>
     *         </ol>
     *     </body>
     * </html>
     *
