...
public class ExercisesFour {
     ...
     *     <body>
     *         <ol>
     *              <li>Exercise 1:   (1) Create a class containing an uninitialized String reference. Demonstrate that
     *                  this reference is initialized by Java to null.</li>
     *
     *              <li>Exercise 2:  (2) Create a class with a String field that is initialized at the point of
     *                  definition, and another one that is initialized by the constructor. What is the difference
     *                  between the two approaches?</li>
     *
     *              <li>Exercise 3:  (1) Create a class with a default constructor (one that takes no arguments) that
     *                  prints a message. Create an object of this class.</li>
     *
     *              <li>Exercise 4:  (1) Add an overloaded constructor to the previous exercise that takes a String
     *                  argument and prints it along with your message.</li>
     *
     *              <li>Exercise 5:  (2) Create a class called Dog with an overloaded bark( ) method. This method
     *                  should be overloaded based on various primitive data types, and print different types of
     *                  barking, howling, etc., depending on which overloaded version is called. Write a main( ) that
     *                  calls all the different versions.</li>
     *
     *              <li>Exercise 6:  (1) Modify the previous exercise so that two of the overloaded methods have two
     *                  arguments (of two different types), but in reversed order relative to each other. Verify that
     *                  this works.</li>
     *
     *              <li>Exercise 7:  (1) Create a class without a constructor, and then create an object of that class
     *                  in main( ) to verify that the default constructor is automatically synthesized.</li>
     *
     *              <li>Exercise 8:   (1) Create a class with two methods. Within the first method, call the second
     *                  method twice: the first time without using this, and the second time using 'this' just to see
     *                  it working; you should not use this form in practice.</li>
     *
     *              <li>Exercise 9:  (1) Create a class with two (overloaded) constructors. Using this, call the second
     *                  constructor inside the first one.</li>
     *
     *              <li>Exercise 10:    (2) Create a class with a finalize( ) method that prints a message. In main( ),
     *                  create an object of your class. Explain the behavior of your program.</li>
     *
     *              <li>Exercise 11:    (4) Modify the previous exercise so that your finalize( ) will always be
     *                  called.</li>
     *
     *              <li>Exercise 12:    (4) Create a class called Tank that can be filled and emptied, and has a
     ...
     *                  that can occur when your Tank is used.</li>
     *
     ...
     *              </li>
     *
     *              <li>Exercise 14:    (1) Create a class with a static String field that is initialized at the point
     ...
     *                  used.</li>
     *
     *              <li>Exercise 15:    (1) Create a class with a String that is initialized using instance
     *                  initialization.</li>
     *
     *              <li>Exercise 16:    (1) Create an array of String objects and assign a String to each element.
     *                  Print the array by using a for loop.</li>
     *
     *              <li>Exercise 17:    (2) Create a class with a constructor that takes a String argument. During
     *                  construction, print the argument. Create an array of object references to this class, but do
     *                  not actually create objects to assign into the array. When you run the program, notice whether
     *                  the initialization messages from the constructor calls are printed.</li>
     *
     *              <li>Exercise 18:    (1) Complete the previous exercise by creating objects to attach to the array
     *                  of references.</li>
     *
     *              <li>Exercise 19:    (2) Write a method that takes a vararg String array. Verify that you can pass
     *                  either a comma-separated list of Strings or a String[] into this method.</li>
     *
     *              <li>Exercise 20:   (1) Create a main( ) that uses varargs instead of the ordinary main( ) syntax.
     *                  Print all the elements in the resulting args array. Test it with various numbers of
     *                  command-line arguments.</li>
     *
     *              <li>Exercise 21:    (1) Create an enum of the least-valuable six types of paper currency. Loop
     *                  through the values( ) and print each value and its ordinal( ).</li>
     *
     *              <li>Exercise 22:   (2) Write a switch statement for the enum in the previous example. For each
     *                  case, output a description of that particular currency.</li>
     *          </ol>
     *      </body>
     * </html>
     */
